...
function Translate () {
    return(
        ...
        <TranslateForm/>
        <img src="https://i.gifer.com/q7Q.gif" alt="lost in translation gif" style={{marginLeft:"37%", marginTop: "15%", height: "250px", width: "450px", opacity: "65%", borderRadius:"150px"}}></img>
        </>
    )
}
